...
import static datapager.util.IOUtility.readResourceFully;
...
public final class DatabaseUtility
{
  ...
  private static final DataPagerLogger LOGGER = DataPagerLogger
    ...
    throws DataPagerException
  {
    ...
    {
      throw new DataPagerException("Bad database connection", e);
    }
  }

  public static Statement createStatement(final Connection connection)
    throws DataPagerException, SQLException
  {
    ...
    throws DataPagerException
  {
    ...
    {
      throw new DataPagerException("Cannot get an integer value result from SQL");
    }
    ...
    throws DataPagerException
  {
        ...
        final ResultSet resultSet = executeSql(statement, sql);)
    {
      ...
      {
        throw new DataPagerException("Too many columns of data returned");
      }
      ...
      if (resultSet.next())
      {
        throw new DataPagerException("Too many rows of data returned");
      }
    ...
    {
      throw new DataPagerException(sql, e);
    }
  }
